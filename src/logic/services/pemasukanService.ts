...
/**
 * Helper JSON untuk Pemasukan Type
 * Mengkonversi format string tunggal ke versi JSON if possible
 */
export const helperParsePemasukanType = (typeString: string | undefined): { name: string, classification: 'Operasional' | 'Aset' } => {
...
export const helperStringifyPemasukanType = (name: string, classification: 'Operasional' | 'Aset'): string => {
